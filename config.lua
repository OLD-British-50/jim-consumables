...
Config = {
	...
	["joint"] = { 					emote = "joint",	time = math.random(5000, 6000), stress = math.random(12, 24), heal = 0, armor = 10, type = "drug", stats = { screen = "weed", effect = "armor", widepupils = false, canOD = false } },
	["weed_skunk_joint"] = { 		emote = "joint",	time = math.random(5000, 6000), stress = math.random(12, 45), heal = 0, armor = 30, type = "drug", stats = { screen = "weed", effect = "armor", widepupils = false, canOD = false } },
	["weed_og-kush_joint"] = { 		emote = "joint",	time = math.random(5000, 6000), stress = math.random(12, 45), heal = 0, armor = 30, type = "drug", stats = { screen = "weed", effect = "armor", widepupils = false, canOD = false } },
	["weed_white-widow_joint"] = { 	emote = "joint",	time = math.random(5000, 6000), stress = math.random(12, 45), heal = 0, armor = 30, type = "drug", stats = { screen = "weed", effect = "armor", widepupils = false, canOD = false } },
	["weed_ak47_joint"] = { 		emote = "joint",	time = math.random(5000, 6000), stress = math.random(12, 45), heal = 0, armor = 30, type = "drug", stats = { screen = "weed", effect = "armor", widepupils = false, canOD = false } },
	["weed_amnesia_joint"] = { 		emote = "joint",	time = math.random(5000, 6000), stress = math.random(12, 45), heal = 0, armor = 30, type = "drug", stats = { screen = "weed", effect = "armor", widepupils = false, canOD = false } },
	["weed_purple-haze_joint"] = { 	emote = "joint",	time = math.random(5000, 6000), stress = math.random(12, 45), heal = 0, armor = 30, type = "drug", stats = { screen = "weed", effect = "armor", widepupils = false, canOD = false } },
	["weed_gelato_joint"] = { 		emote = "joint",	time = math.random(5000, 6000), stress = math.random(12, 45), heal = 0, armor = 30, type = "drug", stats = { screen = "weed", effect = "armor", widepupils = false, canOD = false } },
